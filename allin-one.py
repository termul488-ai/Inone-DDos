...
def udp_plain_flood(ip, port, duration, packet_size):
    ...
    try:
        while time.time() < end_time:
            time.sleep(0.2)
            print(f"[*]\033[94m Starting UDP Plain flood on\033[36m {ip}\033[37m:\033[33m{port} \033[38;5;39m num-attack {packet_count}.")
...
def udp_random_flood(ip, port, duration, packet_size):
    ...
    try:
        while time.time() < end_time:
            time.sleep(0.2)
            print("\033[36m Starting UDP Random flood on \033[38;5;39m{ip}\033[37m:\033[33m{port}\033[97m{packet_count} packets.")
